...
app.post('/api/v1/tours', (req, res) => {
 console.log(req)
   ...
   //When posting data to the sever make sure to convert it into json by using JSON.stringify(your object here). When posting data to the server using a form, you have to group them as as
   res.json('Great')
