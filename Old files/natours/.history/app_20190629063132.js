...
app.post('/api/v1/tours', (req, res) => {
 console.log(req)
   ...
   //When posting data to the sever make sure to convert it into json by using JSON.stringify(your object here). When posting data to the server using a form
   res.json('Great')
